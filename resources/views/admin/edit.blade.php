				...
				<nav id="sideNav"><!-- MAIN MENU -->
					<ul class="nav nav-list">
						...
						<li class="active">
							<a href="#">
								<i class="fa fa-menu-arrow pull-right"></i>
								<i class="main-icon fa fa-pencil-square-o"></i> <span>Edit Mode</span>
							</a>
						...
						<div class="col-md-12">
							...
							<div class="panel panel-default">
								...
								<div class="panel-body">
										...
										<form class="validate" action="/administrator/{{ $item -> id }}" method="post" enctype="multipart/form-data" >
											<fieldset>
												...
												<div class="row">
													<div class="form-group">
														<div class="col-md-6 col-sm-6">
															<label>Merek *</label>
															<input type="text" name="merek" value="{{ $item -> merek }}" class="form-control ">
														</div>
														<div class="col-md-6 col-sm-6">
															<label>Harga *Rp XXX.XXX.XXX</label>
												...
												<div class="row">
													<div class="form-group">
														<div class="col-md-6 col-sm-6">
															<label>Tipe *</label>
															<input type="text" name="tipe" value="{{ $item -> tipe }}" class="form-control ">
														</div>
													</div>
												</div>
												...
												<div class="row">
													<div class="form-group">
														<div class="col-md-12 col-sm-12">
															...
															<select name="kategori" class="form-control pointer ">
																@foreach($ktr as $ktgr)
												...
												<div class="row">
													<div class="form-group">
														<div class="col-md-12 col-sm-12">
															...
															<textarea name="isi" rows="4" class="form-control ">{{ $item -> isi }}</textarea>
														</div>
													</div>
												</div>
													...
													<div class="form-group">
														<div class="col-md-12">
															...
															<div class="fancy-file-upload fancy-file-primary">
																...
																<input type="text" class="form-control" placeholder="{{ $item -> file }}" readonly="" />

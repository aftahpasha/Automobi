					...
					<ul class="nav nav-list">
						...
						<li>
							...
							<ul><!-- submenus -->
								...
								<li>
								<a href="/administrator/transaksi">
									<i class="fa fa-menu-arrow pull-right"></i>
									Transaction
								</a>
							</li>
					...
					<div id="panel-1" class="panel panel-default">
						<div class="panel-heading">
							<span class="title elipsis">
									<strong>ITEM TABLE</strong> <!-- panel title -->
							</span>
							...
							<table class="table table-striped table-hover table-bordered" id="sample_editable_1">
								...
								<tbody>
									...
									<tr>
										...
										<td>
											<a class="btn btn-success" href="administrator/{{$ktgr->id}}/edit">
											Edit </a>
										</td>
										<td>
											<form class="" action="/administrator/{{$ktgr -> id}}" method="post">
					...
					loadScript(plugin_path + "select2/js/select2.full.min.js", function(){
						...
						if (jQuery().dataTable) {
							...
							function saveRow(oTable, nRow) {
								...
								oTable.fnUpdate(jqInputs[3].value, nRow, 3, false);
								oTable.fnUpdate('<a class="edit" href="">Edit</a>', nRow, 4, false);
								oTable.fnUpdate('<a class="delete" href="/administrator{{ $ktgr -> id}}">Delete</a>', nRow, 5, false);
								oTable.fnDraw();
							}
